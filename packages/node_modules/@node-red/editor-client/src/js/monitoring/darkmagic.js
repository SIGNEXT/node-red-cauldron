RED.monitoring = (function () {
    ...
    function injectHTMLIntoNode(nodeId, toStatus) {
        ...
        iDiv.innerHTML += '<div class="monitoring-data" style="display: none; padding-top: 0.2em;">' +
            ...
            '<div class="monitoring-values" style="padding-left: 1em;"><ul style="max-height:65px;overflow:auto;"></ul></div>' +
    ...
    function openLastMessages(nodeId) {
        ...
        win.document.body.innerHTML = '<div class="monitoring-data">' +
            ...
            '<div class="monitoring-values"><ul style="max-height:250px;overflow:auto;"></ul></div>' +
            '</div>';

        var nodeDataDiv = win.document.querySelector(".monitoring-data");

        data[nodeId].values.map(function (element) {
            nodeDataDiv.querySelector(".monitoring-values ul").innerHTML += '<li>' +
