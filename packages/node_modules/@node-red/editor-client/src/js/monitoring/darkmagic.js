RED.monitoring = (function () {
    ...
    function darkmagic() {
        RED.nodes.eachNode(function (node) {
            ...
            injectHTMLIntoNode(node.id, node.tostatus);
        });
    ...
    function injectHTMLIntoNode(nodeId, toStatus) {
        ...
        foreign.setAttribute('height', 250);
        ...
        iDiv.innerHTML += '<div class="monitoring-data" style="display: none; padding-top: 0.2em;">' +
            ...
            '<div class="monitoring-values-input" style="padding-left: 1em;"><ul style="max-height:65px;overflow:auto;"></ul></div>' +
            '<div class="monitoring-values-output" style="padding-left: 1em;"><ul style="max-height:65px;overflow:auto;"></ul></div>' +
            '<div class="monitoring-graphics"><canvas style="display: none;" id="chart-' + nodeId + '" width="' + foreign.getAttribute('width') + '" height="150"></canvas></div>' +
    ...
    function openLastMessages(nodeId) {
        ...
        data[nodeId].input.map(function (element) {
        ...
        data[nodeId].output.map(function (element) {
    ...
    function subscribeMonitoring() {
        RED.comms.subscribe("monitoring", function (topic, event) {
            ...
            updateHTMLNode(nodeId, value, timestamp);
        });
    }

    function updateHTMLNode(nodeId, value, timestamp) {
        ...
        if (typeof (value) == "number")
            drawGraphic(nodeId, graphicElement)
    }

    function drawGraphic(nodeId, graphicElement) {
