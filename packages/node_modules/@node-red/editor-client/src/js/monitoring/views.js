RED.monitoring.view = (function () {
    ...
    function toggleMessageToInput(nodeId) {
        ...
        if(RED.monitoring.data[nodeId].settings.pauseDebug) {
            ...
            valueHTMLElement.outerHTML = '<input type="text" value="' + valueHTMLElement.innerHTML + '" style="width: 90px; height: 25px;"></input>'
        } else {
    ...
    function writeMessage(nodeId, timestamp, value) {
        ...
        if(RED.monitoring.data[nodeId].settings.pauseDebug) {
            valuesDiv.innerHTML += '<input type="text" value="' + value + '" style="width: 90px; height: 25px;"></input>'
        } else {
