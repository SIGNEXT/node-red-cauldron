RED.monitoring.view = (function () {
    ...
    function injectMonitoringButton(nodeId) {
        ...
        monitoringForeign.setAttribute('width', 30);
        monitoringForeign.setAttribute('height', 30);
        monitoringForeign.setAttribute('x', nodeWidth - 30);
        ...
        buttonDiv.innerHTML = '<i id="toggleMonitoring-' + nodeId + '" style="float:right; padding-top: 0.4em; padding-right: 0.3em;" class="fa fa-bug"></i>';
