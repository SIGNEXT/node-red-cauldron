RED.monitoring.view = (function () {
    ...
    function updateMonitoringSize(nodeId) {
        ...
        var monitoringForeign = document.getElementById('monitoringButton-' + nodeId);
        if (monitoringForeign)
            monitoringForeign.setAttribute('x', (rightGroup == null ? nodeWidth - 30 : 9));


        var monitoringDetailsForeign = document.getElementById('monitoringDetails-' + nodeId);
        if (monitoringDetailsForeign)
    ...
    return {
        ...
        updateMonitoringSize: updateMonitoringSize
    }
})();