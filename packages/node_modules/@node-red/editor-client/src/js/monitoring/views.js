RED.monitoring.view = (function () {
    ...
    function injectHTMLIntoNode(nodeId) {
        injectDebugButton(nodeId);

        injectDebugDetails(nodeId);
    }

    function injectDebugButton(nodeId) {
        var nodeElement = document.getElementById(nodeId);

        var debugForeign = document.createElementNS('http://www.w3.org/2000/svg', 'foreignObject');
        debugForeign.setAttribute('id', 'debugButton-' + nodeId);
        debugForeign.setAttribute('width', 30);
        debugForeign.setAttribute('height', 30);
        debugForeign.setAttribute('x', nodeElement.querySelector('.red-ui-flow-node').getAttribute('width') - 30);
        debugForeign.setAttribute('y', 0);
        ...
        debugForeign.appendChild(buttonDiv);
        nodeElement.appendChild(debugForeign);

        document.getElementById('toggleMonitoring-' + nodeId).addEventListener('click', toggleMonitoring.bind(null, nodeId));
    }

    function injectDebugDetails(nodeId) {
        var nodeElement = document.getElementById(nodeId);
        var nodeWidth = nodeElement.querySelector('.red-ui-flow-node').getAttribute('width');

        var debugDetailsForeign = document.createElementNS('http://www.w3.org/2000/svg', 'foreignObject');
        debugDetailsForeign.setAttribute('id', 'debugDetails-' + nodeId);
        debugDetailsForeign.setAttribute('width', nodeWidth);
        debugDetailsForeign.setAttribute('height', 200); //TODO: Change this value bc bugs
        debugDetailsForeign.setAttribute('x', 0);
        debugDetailsForeign.setAttribute('y', 30);
        ...
        iDiv.innerHTML += '<div class="monitoring-graphics" style="padding-bottom: 0.5em;">' +
            ...
            '</div>' +
            '<div class="monitoring-data" style="display: none; padding-top: 0.2em;">' +
        ...
        debugDetailsForeign.appendChild(iDiv);
        nodeElement.appendChild(debugDetailsForeign);
