RED.monitoring.view = (function () {
    ...
    function injectHTMLIntoNode(nodeId) {
        ...
        //Div with node data
        iDiv.innerHTML += '<div class="monitoring-graphics">' +
            '<div style="padding-left: 0.5em; padding-right: 0.5em;"><canvas id="chart-' + nodeId + '"width="' + foreign.getAttribute('width') + '" height="35"></canvas></div>' +
            '</div>' +
